...
\newcommand{\duedate}{Aug 28, 2026, 11:59 PM}
...
\title{\textsc{\hw}\\[0.2em]
{\large\color{hdrcoral}\coursenumber}}
...
\textbf{All CPE 586 students are required to submit their response in a Latex-generated PDF.}
\vskip 1em
\hrule
\vskip 1em
...
Finally, as a part of your submission,  provide URL to your newly created Github. \hfill \textbf{(3 Points)}




\section{Working with UV (45 points)}
A part of this assignment asks you to install \textbf{UV} and create a Python package. It is recommended that you read the documentation at \url{https://docs.astral.sh/uv/}.
...
\textbf{This needs to be outside the folder you created in Part 1. In general it should be outside any git folder or outside any UV project folder.}   
...
Provide the ipynb file for this part of your assignment in the submission. \hfill \textbf{(3 Points)}

\end{enumerate}

\section{Install Visual Studio Code and Important Extensions (5 Points)}
...
\item Download and install Visual Studio Code. \hfill 


\item Go to your test UV environment \texttt{difftest}, activate the virtual environment there, and install the following packages:
...
{bash}
uv pip install pandas matplotlib torch seaborn scikit-learn
\end{minted}


\item Open Visual Studio Code by typing  \hfill 
...
\item Search for and install the following extensions: 
...
\item Install some Python packages as follows by creating a new code cell and executing: \hfill \textbf{(2 Points)}
...
! pip install pandas matplotlib torch seaborn scikit-learn
\end{minted}
...
Provide a public URL to your Google Colab notebook. \hfill \textbf{(7 Points)}
